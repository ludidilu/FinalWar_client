...
{
    public class BattleHeroBuffUnit
    {
        ...
        public Action<BattleHeroBuffUnit, Action> endBack;
        ...
        public BattleHeroBuffUnit(int _index)
        {
        ...
        public void GetScaleFix(Material _material)
        {
            if (go != null)
            {
                ...
                scaleVec4.w = ((float)rankNum - 1)  * (-0.5f * BattleHeroBuff.FONT_WIDTH) + ((float)rank * BattleHeroBuff.FONT_WIDTH);
            }
